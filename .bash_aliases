...
alias kdelpnf='kubectl delete pod --now --force'
...
alias kgyd='kubectl get deployment -o yaml'
alias kgyp='kubectl get pod -o yaml'
alias kgycm='kubectl get configmap -o yaml'
alias kgym='kubectl get mapping -o yaml'
alias kgys='kubectl get secret -o yaml'
alias kl='kubectl logs'
alias klf='kubectl logs -f'
alias kll='kubectl logs -l'
alias kllf='kubectl logs -fl'
